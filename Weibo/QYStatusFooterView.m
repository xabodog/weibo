...
-(void)reAction:(UIButton *)btn{
    //回调参数
    _Block(_footerStatus,btn.tag-1);
}
...
-(UIButton *)reTwitterBtn{
    if (_reTwitterBtn == nil) {
        ...
        _reTwitterBtn.tag=1;
        [_reTwitterBtn addTarget:self action:@selector(reAction:)    forControlEvents:UIControlEventTouchUpInside];
...
-(UIButton *)commentBtn{
    if (_commentBtn == nil) {
        ...
        _commentBtn.tag=2;
        [_commentBtn addTarget:self action:@selector(reAction:)    forControlEvents:UIControlEventTouchUpInside];
...
-(UIButton *)likeBtn{
    if (_likeBtn == nil) {
        ...
        _likeBtn.tag=3;
        [_likeBtn addTarget:self action:@selector(reAction:)    forControlEvents:UIControlEventTouchUpInside];

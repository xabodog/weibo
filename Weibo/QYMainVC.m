...
-(void)composeAction:(UIButton *)composeItme{
    //1.初始化控制
    QYSendStatusVC *vc=[self.storyboard instantiateViewControllerWithIdentifier:@"QYSendStatusId"];
    UINavigationController *natavation=[[UINavigationController alloc] initWithRootViewController:vc];
    //设置类型
     vc.type=WRITETYPE;
    [self presentViewController:natavation animated:YES completion:nil];
